...
class StandControllerNode(Node):
    def __init__(self):    
        ...
        # self.matrix = [[0.0, 5.0, -3.0], [0.0, 5.0, 0.0], [0.0, 5.0, -3.0], [0.0, 5.0, -3.0], [0.0, 3.0, 2.0], [0.0, 5.0, 0.0]]

        self.matrix = [[0.0, 5.0, -3.0], [0.0, 2.75, -4.0], [0.0, 5.0, -3.0], [0.0, 5.0, -3.0], [0.0, 2.75, -4.0], [0.0, 5.0, -3.0]]
